...
```
Error: locator.click: Unsupported token "{" while parsing css selector "page.getByText('shopping cart', { exact: true })". Did you mean to CSS.escape it?
Call log:
  - waiting for page.getByText('shopping cart', { exact: true })
