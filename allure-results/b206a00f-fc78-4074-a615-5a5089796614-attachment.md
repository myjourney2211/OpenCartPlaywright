        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: Password@1234567890
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: testagent@test.com
...
```ts
  ...
  33 | 
> 34 |     expect(myAccPg.myAccountPageVisibility()).toContain("My Account");
     |                                               ^ TypeError: received is not iterable
  35 | 
  36 | 
  37 | })
