        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            ...
            - generic [ref=e95]:
              ...
              - textbox "Password" [ref=e97]: Password@123456789
...
```ts
  ...
  14 |     home = new homePage(page);
  15 |     loginpg = new loginPage(page);
  16 |     myAccPg = new myAccountPage(page);
  ...
  33 | 
  34 |     //expect(await myAccPg.myAccountPageVisibility()).toContain("My Account");
> 35 |     expect(await myAccPg.isMyAccountPageExists()).toBeTruthy();
     |                                                   ^ Error: expect(received).toBeTruthy()
  36 | 
  37 | })
  38 | 
